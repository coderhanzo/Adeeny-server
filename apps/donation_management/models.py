...
class ProjectDonation(models.Model):
    ...
    amount = MoneyField(max_digits=14, decimal_places=2, default_currency='GHC',blank=True, null=True) # this will be the for donations data
    target_amount = MoneyField(max_digits=14, decimal_places=2, default_currency='GHC',blank=True, null=True) # this will be the waqf data
