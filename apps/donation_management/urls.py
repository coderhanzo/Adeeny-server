...
urlpatterns = [
    ...
    path("delete-waqf-donations/", views.delete_donation, name="delete_waqf_donation"), # deletes a waqf if the date is in the future, else sets is_active to false if date is in the past
